...
public class TestAppResource extends BaseJerseyTest {
        ...
        public void testSmtpConfiguration() {
                ...
                target().path("/app/config_smtp").request()
                                ...
                                .post(Entity.form(new Form()
                                                ...
                                                .param("from", "contact@sismics.com")), JsonObject.class);
        ...
        public void testInbox() {
                ...
                target().path("/app/config_inbox").request()
                                ...
                                .post(Entity.form(new Form()
                                                ...
                                                .param("folder", "INBOX")
                                                .param("tag", tagInboxId)), JsonObject.class);
                configInboxChanged = true;
                ...
                // Send an email
                GreenMailUtil.sendTextEmail("test@sismics.com", "test@sismicsdocs.com", "Test email 1",
                                "Test content 1", serverSetupSmtp);
        ...
        public void testLdapAuthentication() throws Exception {
                ...
                new LdifFileLoader(directoryService.getAdminSession(),
                                new File(Resources.getResource("test.ldif").getFile()), null).execute();
                ...
                target().path("/app/config_ldap").request()
                                ...
                                .post(Entity.form(new Form()
                                                ...
                                                .param("default_storage", "100000000")), JsonObject.class);
